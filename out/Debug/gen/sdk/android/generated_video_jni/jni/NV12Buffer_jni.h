...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_NV12Buffer_clazz =
    0;
...
static void JNI_NV12Buffer_CropAndScale(JNIEnv* env, const
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_NV12Buffer_nativeCropAndScale(JNIEnv*
    env, jclass jcaller,
    jint cropX,
    jint cropY,
    jint cropWidth,
    ...
    jobject dstV,
    jint dstStrideV) {
  return JNI_NV12Buffer_CropAndScale(env,
      base::android::JavaParamRef<jclass>(env, jcaller), cropX, cropY,
      cropWidth, cropHeight, scaleWidth, scaleHeight,
      base::android::JavaParamRef<jobject>(env, src), srcWidth, srcHeight,
      srcStride, srcSliceHeight, base::android::JavaParamRef<jobject>(env,
      dstY), dstStrideY, base::android::JavaParamRef<jobject>(env, dstU),
      dstStrideU, base::android::JavaParamRef<jobject>(env, dstV), dstStrideV);
}
