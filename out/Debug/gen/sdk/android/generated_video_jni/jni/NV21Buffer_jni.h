...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_NV21Buffer_clazz =
    0;
...
static void JNI_NV21Buffer_CropAndScale(JNIEnv* env, const
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_NV21Buffer_nativeCropAndScale(JNIEnv*
    env, jclass jcaller,
    jint cropX,
    jint cropY,
    jint cropWidth,
    ...
    jobject dstV,
    jint dstStrideV) {
  return JNI_NV21Buffer_CropAndScale(env,
