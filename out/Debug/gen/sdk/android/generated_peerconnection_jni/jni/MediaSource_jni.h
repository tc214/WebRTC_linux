...
static base::android::ScopedJavaLocalRef<jobject>
    JNI_MediaSource_GetState(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong pointer);

JNI_GENERATOR_EXPORT jobject Java_org_webrtc_MediaSource_nativeGetState(JNIEnv*
    env, jclass jcaller,
    jlong pointer) {
  return JNI_MediaSource_GetState(env, base::android::JavaParamRef<jclass>(env,
      jcaller), pointer).Release();
}
