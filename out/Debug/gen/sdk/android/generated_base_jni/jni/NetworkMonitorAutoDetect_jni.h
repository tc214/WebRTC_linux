...
JNI_REGISTRATION_EXPORT extern const char
    kClassPath_org_webrtc_NetworkMonitorAutoDetect[];
const char kClassPath_org_webrtc_NetworkMonitorAutoDetect[] =
    "org/webrtc/NetworkMonitorAutoDetect";
...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord
    g_org_webrtc_NetworkMonitorAutoDetect_clazz = 0;
...
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord
    g_org_webrtc_NetworkMonitorAutoDetect_00024NetworkInformation_clazz = 0;
...
inline jclass
    org_webrtc_NetworkMonitorAutoDetect_00024NetworkInformation_clazz(JNIEnv*
    env) {
  return base::android::LazyGetClass(env,
      kClassPath_org_webrtc_NetworkMonitorAutoDetect_00024NetworkInformation,
...
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord
    g_org_webrtc_NetworkMonitorAutoDetect_00024IPAddress_clazz = 0;
...
inline jclass org_webrtc_NetworkMonitorAutoDetect_00024IPAddress_clazz(JNIEnv*
    env) {
  return base::android::LazyGetClass(env,
      kClassPath_org_webrtc_NetworkMonitorAutoDetect_00024IPAddress,
...
static base::subtle::AtomicWord
    g_org_webrtc_NetworkMonitorAutoDetect_00024IPAddress_getAddress = 0;
static base::android::ScopedJavaLocalRef<jbyteArray>
    Java_IPAddress_getAddress(JNIEnv* env, const
...
static base::android::ScopedJavaLocalRef<jobjectArray>
    Java_NetworkInformation_getIpAddresses(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      org_webrtc_NetworkMonitorAutoDetect_00024NetworkInformation_clazz(env),
          NULL);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_INSTANCE>(
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_NetworkInformation_getConnectionType(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      org_webrtc_NetworkMonitorAutoDetect_00024NetworkInformation_clazz(env),
          NULL);
...
static base::subtle::AtomicWord
    g_org_webrtc_NetworkMonitorAutoDetect_00024NetworkInformation_getHandle = 0;
static jlong Java_NetworkInformation_getHandle(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      org_webrtc_NetworkMonitorAutoDetect_00024NetworkInformation_clazz(env),
          0);
...
static base::subtle::AtomicWord
    g_org_webrtc_NetworkMonitorAutoDetect_00024NetworkInformation_getName = 0;
static base::android::ScopedJavaLocalRef<jstring>
    Java_NetworkInformation_getName(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      org_webrtc_NetworkMonitorAutoDetect_00024NetworkInformation_clazz(env),
          NULL);
