...
static void JNI_YuvHelper_I420Rotate(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    const base::android::JavaParamRef<jobject>& srcY,
    jint srcStrideY,
    const base::android::JavaParamRef<jobject>& srcU,
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_YuvHelper_nativeI420Rotate(JNIEnv*
    env, jclass jcaller,
    jobject srcY,
    jint srcStrideY,
    jobject srcU,
    ...
    jint srcHeight,
    jint rotationMode) {
  return JNI_YuvHelper_I420Rotate(env, base::android::JavaParamRef<jclass>(env,
      jcaller), base::android::JavaParamRef<jobject>(env, srcY), srcStrideY,
      base::android::JavaParamRef<jobject>(env, srcU), srcStrideU,
      base::android::JavaParamRef<jobject>(env, srcV), srcStrideV,
      base::android::JavaParamRef<jobject>(env, dstY), dstStrideY,
      base::android::JavaParamRef<jobject>(env, dstU), dstStrideU,
      base::android::JavaParamRef<jobject>(env, dstV), dstStrideV, srcWidth,
      srcHeight, rotationMode);
}
