...
const char kClassPath_org_webrtc_Metrics_00024HistogramInfo[] =
    "org/webrtc/Metrics$HistogramInfo";

// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_Metrics_clazz = 0;
...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord
    g_org_webrtc_Metrics_00024HistogramInfo_clazz = 0;
...
static void JNI_Metrics_Enable(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller);

JNI_GENERATOR_EXPORT void Java_org_webrtc_Metrics_nativeEnable(JNIEnv* env,
    jclass jcaller) {
  return JNI_Metrics_Enable(env, base::android::JavaParamRef<jclass>(env,
      jcaller));
}

static base::android::ScopedJavaLocalRef<jobject>
    JNI_Metrics_GetAndReset(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller);

JNI_GENERATOR_EXPORT jobject Java_org_webrtc_Metrics_nativeGetAndReset(JNIEnv*
    env, jclass jcaller) {
  return JNI_Metrics_GetAndReset(env, base::android::JavaParamRef<jclass>(env,
      jcaller)).Release();
}

static base::subtle::AtomicWord g_org_webrtc_Metrics_Constructor = 0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_Metrics_Constructor(JNIEnv* env) {
...
static base::subtle::AtomicWord
    g_org_webrtc_Metrics_00024HistogramInfo_Constructor = 0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_HistogramInfo_Constructor(JNIEnv* env, JniIntWrapper min,
    JniIntWrapper max,
...
static base::subtle::AtomicWord
    g_org_webrtc_Metrics_00024HistogramInfo_addSample = 0;
static void Java_HistogramInfo_addSample(JNIEnv* env, const
...
static base::subtle::AtomicWord g_org_webrtc_Metrics_add = 0;
static void Java_Metrics_add(JNIEnv* env, const base::android::JavaRef<jobject>&
    obj, const base::android::JavaRef<jstring>& name,
