...
JNI_GENERATOR_EXPORT void
    Java_org_webrtc_VideoDecoderWrapper_nativeOnDecodedFrame(JNIEnv* env,
    jobject jcaller,
    jlong nativeDecoder,
    jobject frame,
    jobject decodeTimeMs,
    jobject qp) {
  webrtc::jni::VideoDecoderWrapper* native =
      reinterpret_cast<webrtc::jni::VideoDecoderWrapper*>(nativeDecoder);
  CHECK_NATIVE_PTR(env, jcaller, native, "OnDecodedFrame");
  return native->OnDecodedFrame(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jobject>(env, frame),
