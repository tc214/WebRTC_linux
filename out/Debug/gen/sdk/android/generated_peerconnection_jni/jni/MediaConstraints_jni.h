...
JNI_REGISTRATION_EXPORT extern const char
    kClassPath_org_webrtc_MediaConstraints[];
const char kClassPath_org_webrtc_MediaConstraints[] =
    "org/webrtc/MediaConstraints";
...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord
    g_org_webrtc_MediaConstraints_clazz = 0;
...
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord
    g_org_webrtc_MediaConstraints_00024KeyValuePair_clazz = 0;
...
static base::subtle::AtomicWord
    g_org_webrtc_MediaConstraints_00024KeyValuePair_getKey = 0;
static base::android::ScopedJavaLocalRef<jstring>
    Java_KeyValuePair_getKey(JNIEnv* env, const base::android::JavaRef<jobject>&
    obj) {
...
static base::subtle::AtomicWord
    g_org_webrtc_MediaConstraints_00024KeyValuePair_getValue = 0;
static base::android::ScopedJavaLocalRef<jstring>
    Java_KeyValuePair_getValue(JNIEnv* env, const
...
static base::subtle::AtomicWord g_org_webrtc_MediaConstraints_getMandatory = 0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_MediaConstraints_getMandatory(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
...
static base::subtle::AtomicWord g_org_webrtc_MediaConstraints_getOptional = 0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_MediaConstraints_getOptional(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      org_webrtc_MediaConstraints_clazz(env), NULL);
  jmethodID method_id =
