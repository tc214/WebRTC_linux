...
JNI_GENERATOR_EXPORT void
    Java_org_webrtc_TurnCustomizer_nativeFreeTurnCustomizer(JNIEnv* env, jclass
    jcaller,
    jlong turnCustomizer) {
  return JNI_TurnCustomizer_FreeTurnCustomizer(env,
      base::android::JavaParamRef<jclass>(env, jcaller), turnCustomizer);
}

static base::subtle::AtomicWord
    g_org_webrtc_TurnCustomizer_getNativeTurnCustomizer = 0;
