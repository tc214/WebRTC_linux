...
JNI_GENERATOR_EXPORT void
    Java_org_webrtc_VideoEncoderWrapper_nativeOnEncodedFrame(JNIEnv* env,
    jobject jcaller,
    jlong nativeEncoder,
    jobject buffer,
    jint encodedWidth,
    ...
    jobject qp) {
  webrtc::jni::VideoEncoderWrapper* native =
      reinterpret_cast<webrtc::jni::VideoEncoderWrapper*>(nativeEncoder);
  CHECK_NATIVE_PTR(env, jcaller, native, "OnEncodedFrame");
  return native->OnEncodedFrame(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jobject>(env, buffer), encodedWidth,
