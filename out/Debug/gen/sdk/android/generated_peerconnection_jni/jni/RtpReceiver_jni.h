...
static jlong JNI_RtpReceiver_GetTrack(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong rtpReceiver);

JNI_GENERATOR_EXPORT jlong Java_org_webrtc_RtpReceiver_nativeGetTrack(JNIEnv*
    env, jclass jcaller,
    jlong rtpReceiver) {
  return JNI_RtpReceiver_GetTrack(env, base::android::JavaParamRef<jclass>(env,
      jcaller), rtpReceiver);
}
...
JNI_GENERATOR_EXPORT jboolean
    Java_org_webrtc_RtpReceiver_nativeSetParameters(JNIEnv* env, jclass jcaller,
    jlong rtpReceiver,
    jobject parameters) {
  return JNI_RtpReceiver_SetParameters(env,
      base::android::JavaParamRef<jclass>(env, jcaller), rtpReceiver,
      base::android::JavaParamRef<jobject>(env, parameters));
}

static base::android::ScopedJavaLocalRef<jobject>
    JNI_RtpReceiver_GetParameters(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong rtpReceiver);

JNI_GENERATOR_EXPORT jobject
    Java_org_webrtc_RtpReceiver_nativeGetParameters(JNIEnv* env, jclass jcaller,
    jlong rtpReceiver) {
  return JNI_RtpReceiver_GetParameters(env,
      base::android::JavaParamRef<jclass>(env, jcaller), rtpReceiver).Release();
}

static base::android::ScopedJavaLocalRef<jstring> JNI_RtpReceiver_GetId(JNIEnv*
    env, const base::android::JavaParamRef<jclass>& jcaller,
    jlong rtpReceiver);

JNI_GENERATOR_EXPORT jstring Java_org_webrtc_RtpReceiver_nativeGetId(JNIEnv*
    env, jclass jcaller,
    jlong rtpReceiver) {
  return JNI_RtpReceiver_GetId(env, base::android::JavaParamRef<jclass>(env,
      jcaller), rtpReceiver).Release();
}

static jlong JNI_RtpReceiver_SetObserver(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong rtpReceiver,
    const base::android::JavaParamRef<jobject>& observer);

JNI_GENERATOR_EXPORT jlong Java_org_webrtc_RtpReceiver_nativeSetObserver(JNIEnv*
    env, jclass jcaller,
    jlong rtpReceiver,
    jobject observer) {
  return JNI_RtpReceiver_SetObserver(env,
      base::android::JavaParamRef<jclass>(env, jcaller), rtpReceiver,
      base::android::JavaParamRef<jobject>(env, observer));
}

static void JNI_RtpReceiver_UnsetObserver(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong rtpReceiver,
    jlong nativeObserver);

JNI_GENERATOR_EXPORT void
    Java_org_webrtc_RtpReceiver_nativeUnsetObserver(JNIEnv* env, jclass jcaller,
    jlong rtpReceiver,
    jlong nativeObserver) {
  return JNI_RtpReceiver_UnsetObserver(env,
      base::android::JavaParamRef<jclass>(env, jcaller), rtpReceiver,
      nativeObserver);
}
