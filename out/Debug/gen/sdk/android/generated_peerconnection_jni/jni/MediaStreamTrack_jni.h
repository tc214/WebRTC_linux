...
static base::android::ScopedJavaLocalRef<jstring>
    JNI_MediaStreamTrack_GetId(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong track);

JNI_GENERATOR_EXPORT jstring
    Java_org_webrtc_MediaStreamTrack_nativeGetId(JNIEnv* env, jclass jcaller,
    jlong track) {
  return JNI_MediaStreamTrack_GetId(env,
      base::android::JavaParamRef<jclass>(env, jcaller), track).Release();
}

static base::android::ScopedJavaLocalRef<jstring>
    JNI_MediaStreamTrack_GetKind(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong track);

JNI_GENERATOR_EXPORT jstring
    Java_org_webrtc_MediaStreamTrack_nativeGetKind(JNIEnv* env, jclass jcaller,
    jlong track) {
  return JNI_MediaStreamTrack_GetKind(env,
      base::android::JavaParamRef<jclass>(env, jcaller), track).Release();
}
...
JNI_GENERATOR_EXPORT jboolean
    Java_org_webrtc_MediaStreamTrack_nativeGetEnabled(JNIEnv* env, jclass
    jcaller,
    jlong track) {
  return JNI_MediaStreamTrack_GetEnabled(env,
      base::android::JavaParamRef<jclass>(env, jcaller), track);
}
...
JNI_GENERATOR_EXPORT jboolean
    Java_org_webrtc_MediaStreamTrack_nativeSetEnabled(JNIEnv* env, jclass
    jcaller,
    jlong track,
    jboolean enabled) {
  return JNI_MediaStreamTrack_SetEnabled(env,
      base::android::JavaParamRef<jclass>(env, jcaller), track, enabled);
}

static base::android::ScopedJavaLocalRef<jobject>
    JNI_MediaStreamTrack_GetState(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong track);

JNI_GENERATOR_EXPORT jobject
    Java_org_webrtc_MediaStreamTrack_nativeGetState(JNIEnv* env, jclass jcaller,
    jlong track) {
  return JNI_MediaStreamTrack_GetState(env,
      base::android::JavaParamRef<jclass>(env, jcaller), track).Release();
}
